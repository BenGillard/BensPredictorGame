...
UpcomingGame1<- table(unlist(UpcomingGames[[1]]))
UpcomingGame2<- table(unlist(UpcomingGames[[2]]))
UpcomingGame3<- as.data.frame(table(unlist(UpcomingGames[[3]])))#get counts of the three options from all dataframes

#horizontal barplot with proportions of home/draw/away

barplot(UpcomingGame3)

ggplot() + geom_col(data = UpcomingGame3, aes(y = Freq), stat = "identity", position = "stack")#, fill = Var1)
