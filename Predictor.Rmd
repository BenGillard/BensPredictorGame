...
TrueResults<- readxl::read_excel("PredictorTrueResults.xlsm")[7:79, 5:8] #change dimensions depending on number of games
...
predictions<- predictionsRoot[7:79, 5:8] #change dimensions depending on number of games
...
These are test results to make sure everything is working properly! Once all entries have been submitted, the webpage will be updated with the real stuff.
