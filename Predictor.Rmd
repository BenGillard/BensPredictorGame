...
DoneGames<- which(!is.na(ResultsSoFar$HomeScore))

UpcomingGames<- lapply(1:4, function(y) lapply(Results, function(x) head(x[-DoneGames,"Result"], n = 4)[y])) #remove donegames from results dataframes and get the next 3 games from each dataframe (using head n=3)
