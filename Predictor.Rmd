...
We have **`r totalplayers` players** involved so we have a healthy kitty to pay out for the **top 6 players. £`r round(x = totalplayers*5*0.445, digits = 3)` goes to the top dog. £`r round(x = totalplayers*5*0.245, digits = 3)` for the top loser. £`r round(x = totalplayers*5*0.145, digits = 3)` for the best of the rest. And £`r round(x = totalplayers*5*0.055, digits = 3)` for 4th, 5th, and 6th places.** *Although the bragging rights remain the most valuable prize.*
