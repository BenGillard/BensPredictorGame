...
**Follow this [link](https://github.com/BenGillard/BensPredictorGame/blob/main/Predictor.xlsm?raw=true) to download the entry spreadsheet or email benspredictorgame@gmail.com with the subject "I want to play!".** Please send the completed spreadsheet file with the subject line "Predictor 2026" to benspredictorgame@gmail.com. Then forward this website to all your friends so they can get involved too. **Deadline is 10pm on Sunday 9th June** ahead of the first fixture on 11th June so get your entry in quick!
