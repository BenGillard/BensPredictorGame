...
TrueResults<- readxl::read_excel("PredictorTrueResults.xlsm")[7:43, 5:8] #change dimensions depending on number of games
...
predictions<- predictionsRoot[7:43, 5:8] #change dimensions depending on number of games
...
**Follow this [link](https://github.com/BenGillard/Qatar2022Predictor/blob/main/Predictor.xlsm?raw=true) to download the entry spreadsheet.** Please send the completed spreadsheet file with the subject line "Predictor 2024" to benspredictorgame@gmail.com. Then forward to all your friends so they can get involved too. Deadline is Tuesday 11th November ahead of the first fixture on 14th June so get your entry in quick!
...
#date information
ResultsSoFar<- readxl::read_excel("PredictorTrueResults.xlsm")[7:43, c(3,5:8)] #change depending on the number of fixtures
...
=======
>>>>>>> 38de07850843278800d6808522ec76df62a5c932
```{r ExtraBits}
